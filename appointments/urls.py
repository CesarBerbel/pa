...
urlpatterns = [
    ...
    path("diagnostico/lembretes/", ReminderDiagnosticsView.as_view(), name="reminder_diagnostics"),
    ...
    path("bloqueios/<int:pk>/apagar/", ScheduleBlockDeleteView.as_view(), name="schedule_block_delete"),
    ...
    path("servicos/<int:pk>/apagar/", ServiceDeleteView.as_view(), name="service_delete"),
...
path("clientes/<int:pk>/apagar/", CustomerDeleteView.as_view(), name="customer_delete"),
